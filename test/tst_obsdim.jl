...
@testset "helper constructor" begin
    ...
    @test MLDataUtils.obs_dim(ObsDim.First()) === ObsDim.Constant(1)
...
@testset "default values" begin
    @testset "Arrays, SubArrays, and Sparse Arrays" begin
        @test MLDataUtils.default_obsdim(rand(10)) === ObsDim.Last()
        @test MLDataUtils.default_obsdim(view(rand(10),:)) === ObsDim.Last()
        @test MLDataUtils.default_obsdim(rand(10,5)) === ObsDim.Last()
        @test MLDataUtils.default_obsdim(view(rand(10,5),:,:)) === ObsDim.Last()
        @test MLDataUtils.default_obsdim(sprand(10,0.5)) === ObsDim.Last()
        @test MLDataUtils.default_obsdim(sprand(10,5,0.5)) === ObsDim.Last()
    end

    @testset "Types with no specified default" begin
        @test MLDataUtils.default_obsdim(SomeType()) === ObsDim.Undefined()
    end

    @testset "Tuples" begin
        @test MLDataUtils.default_obsdim((SomeType(),SomeType())) === (ObsDim.Undefined(), ObsDim.Undefined())
        @test MLDataUtils.default_obsdim((SomeType(),rand(2,2))) === (ObsDim.Undefined(), ObsDim.Last())
        @test MLDataUtils.default_obsdim((rand(10),SomeType())) === (ObsDim.Last(), ObsDim.Undefined())
        @test MLDataUtils.default_obsdim((rand(10),rand(2,2))) === (ObsDim.Last(), ObsDim.Last())
    end
end
