@testset "Test load_iris" begin
    ...
    @test mean(xtmp, 2) ≈ [5.843333333333333333, 3.05733333333333333, 3.758000, 1.199333333333333]
    @test mean(xtmp[:,1:50], 2) ≈ [5.006, 3.428, 1.462, 0.246]
    @test mean(xtmp[:,51:100], 2) ≈ [5.936, 2.77, 4.26, 1.326]
end
